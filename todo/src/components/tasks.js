import {TaskListApi, TaskCreateApi, TaskDeleteApi, TaskCompleteApi} from '../lookup/lookup';
...
function TaskComplete(props){
    ...
    return (
        <form onSubmit={handleComplete} className="mb-2">
            <button type="delete" className={style}>
        ...
        <div className='text-white mt-5 container'>
           <ul className="list-group">
                ...
                <li key={item.id} className="list-group-item d-flex justify-content-between align-items-center Task mb-1">
                    ...
                    <div>
                        <TaskComplete id={item.id}  data = {item}/>
                ...
                <div>
                    <div className='col-12 m-3 w-75 mx-auto'>
                        <form onSubmit={this.handleSubmit}>
                            <textarea type="text" value={this.state.description} onChange={this.handleChange} className='form-control'>
